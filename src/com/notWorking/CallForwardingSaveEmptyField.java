...
public class CallForwardingSaveEmptyField   extends TestBaseReg{
	@Test
	public void callForwardingMightAddNewNumbers () throws Exception {	 
		...
		selenium.click("link=Переадресация вызовов");//Нажатие на кнопку "Переадресация"
		Thread.sleep(3000);
		AssertJUnit.assertEquals(selenium.getValue("id=edit-schedule-0-followme-number"), "");//Проверить, пусто ли поле ввода номера
